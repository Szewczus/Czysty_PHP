...
if($id!=$id_z_bazy && $id!='')
{
    ...
    if($ile_rezerwacji==0)
    {
        echo "<div id='kontener_warning'><h1>Nie można dokonać usunięcia rezerwacji, ponieważ jeszcze nie została zarezerwowana</h1></div>";
    }
    else
    {
        ...
        echo "<h1>Usuń rezerwacje:</h1>";
        echo "<form action='usun_z_bazy.php' method='post'>";
            echo "<select name='rezerwacja'>";
            ...
            echo "</select>";
            echo "<input type='submit' value='Usuń' name='submit'>";
        echo '</form>';
    }
}
else
